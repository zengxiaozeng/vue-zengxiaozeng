...
.yo-scroll {
    ...
    .inner {
        ...
        .up-tip:before {
            background: url(http://yiding-images.oss-cn-shanghai.aliyuncs.com/H5/welfare/down-logo.png) no-repeat center;
        }
        .refresh-tip:before {
            background: url(http://yiding-images.oss-cn-shanghai.aliyuncs.com/H5/welfare/refresh-logo.gif) no-repeat center;
        }
    }
}
